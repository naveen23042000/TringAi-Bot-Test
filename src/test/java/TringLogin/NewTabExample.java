...
public class NewTabExample {
    public static void main(String[] args) throws InterruptedException {
        ...
        // Sign in process
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("E-mail"))).sendKeys("billing@yopmail.com");
        ...
        // Wait for and interact with the target element by sending "Hello" and pressing Enter
        ...
        elementOnNewTab.sendKeys("Site Visit" + Keys.ENTER);  // Sends "Hello" followed by Enter key
        
        // Commented for Site visit as of now need only for the Interacted chats
		/*
		 * Thread.sleep(7000);
		 * 
		 ...
		 */
        // Optional: Switch back to the original tab if needed
        // driver.switchTo().window(originalWindow);

        // Close the driver at the end of the session (uncomment if needed)
        // driver.quit();
